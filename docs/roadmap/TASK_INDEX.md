...
|---|---|---:|---|---|---|
| [M00-001](../../docs/tasks/M00-001-lock-supported-toolchain-and-dependency-baselines.md) | M00 | P0 | TODO | None | Lock supported toolchain and dependency baselines |
| [M00-002](../../docs/tasks/M00-002-enforce-clean-dependency-and-module-boundaries.md) | M00 | P0 | TODO | M00-001 | Enforce clean dependency and module boundaries |
| [M00-003](../../docs/tasks/M00-003-establish-local-postgresql-redis-development-environment.md) | M00 | P0 | TODO | M00-001 | Establish local PostgreSQL/Redis development environment |
...
| [M00-008](../../docs/tasks/M00-008-add-tracing-metrics-foundation.md) | M00 | P1 | TODO | M00-007 | Add tracing/metrics foundation |
...
| [M02-001](../../docs/tasks/M02-001-implement-identity-model-and-authentication-service.md) | M02 | P0 | TODO | M00-006 | Implement identity model and authentication service |
...
| [M03-001](../../docs/tasks/M03-001-implement-canonical-country-and-service-catalog.md) | M03 | P0 | TODO | M00-006 | Implement canonical Country and Service catalog |
| [M03-002](../../docs/tasks/M03-002-implement-product-sku-model-for-virtual-number-offerings.md) | M03 | P0 | TODO | M03-001 | Implement Product/SKU model for virtual-number offerings |
| [M03-003](../../docs/tasks/M03-003-implement-provider-registry-and-canonical-mappings.md) | M03 | P0 | TODO | M03-001 | Implement provider registry and canonical mappings |
| [M03-004](../../docs/tasks/M03-004-implement-catalog-query-read-models.md) | M03 | P1 | TODO | M03-002, M03-003 | Implement catalog/query read models |
