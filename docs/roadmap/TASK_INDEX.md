...
| [M02-005](../../docs/tasks/M02-005-decide-and-document-cross-domain-sso-v1-scope.md) | M02 | P1 | DONE | M02-002 | Decide and document cross-domain SSO v1 scope |
...
| [M04-006](../../docs/tasks/M04-006-implement-safe-failover-and-ambiguous-outcome-reconciliation.md) | M04 | P0 | DONE | M04-005 | Implement safe failover and ambiguous-outcome reconciliation |
...
| [M05-005](../../docs/tasks/M05-005-implement-exchange-rate-source-abstraction-if-required.md) | M05 | P2 | DONE | M05-001 | Implement exchange-rate source abstraction if required |
| [M06-001](../../docs/tasks/M06-001-implement-order-aggregate-and-explicit-state-machine.md) | M06 | P0 | DONE | M05-002 | Implement Order aggregate and explicit state machine |
...
| [M07-004](../../docs/tasks/M07-004-implement-expiry-cancel-refund-compensation-workflow.md) | M07 | P0 | DONE | M07-003, M05-004 | Implement expiry/cancel/refund compensation workflow |
| [M07-005](../../docs/tasks/M07-005-implement-reconciliation-and-manual-review-cases.md) | M07 | P0 | DONE | M07-004 | Implement reconciliation and Manual Review cases |
...
| [M09-003](../../docs/tasks/M09-003-implement-catalog-provider-mapping-management.md) | M09 | P0 | DONE | M03-003, M09-001 | Implement catalog/provider mapping management |
